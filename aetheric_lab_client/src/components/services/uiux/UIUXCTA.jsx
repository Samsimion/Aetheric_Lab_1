  ...
  return (
    <section className="relative overflow-hidden bg-[#EAF4FF] py-16 lg:py-20">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-[-100px] top-[-140px] h-[430px] w-[430px] rounded-full border border-[#BBD7F5]" />

        <div className="absolute right-[-30px] top-[-70px] h-[310px] w-[310px] rounded-full border border-[#CDE2F8]" />
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="border-l border-[#BFD7F4] pl-7 lg:pl-10">
            ...
            <p className="max-w-xl text-base leading-7 text-[#526784]">
              From the first idea to a fully designed product, let's
              create something people will love to use.
            </p>
